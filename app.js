var app = new Vue({
	...
	data:{
		tasks: [
      		{id: 1, name: 'Todo 1' ,description: 'This is a todo 1', completed: false},
      		{id: 2, name: 'Todo 2' ,description: 'This is a todo 2', completed: false},
      		{id: 3, name: 'Todo 3' ,description: 'This is a todo 3', completed: true},
      		{id: 4, name: 'Todo 4' ,description: 'This is a todo 4', completed: true}
      	],
		task: {},
		message: '',
		action:'create'
  ...
  methods:{
  	...
  	deleteTask: function(event,id){
  		...
  		if(taskIndex > -1){
  			this.$delete(this.tasks, taskIndex)    //$delete is a vue method
